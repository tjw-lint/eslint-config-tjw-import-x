# eslint-config-tjw-import-x

The Jared Wilcurt's strict ESLint rules for ESM imports/exports.


## Using this

1. `npm install --save-dev eslint@10 eslint-plugin-import-x@4 eslint-config-tjw-import-x@latest`
